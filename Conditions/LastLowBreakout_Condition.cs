...
{
    [Description("This indicator shows an arrow on a new x days. The indicator will plot 1 if there was a low in a specific range (default: 52 week high in a 14 days range). ")]
...
namespace AgenaTrader.UserCode
{
	...
	{
		/// <summary>
		/// This indicator shows an arrow on a new x days. The indicator will plot 1 if there was a low in a specific range (default: 52 week high in a 14 days range). 
		/// </summary>
